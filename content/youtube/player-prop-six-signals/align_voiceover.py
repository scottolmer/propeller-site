#!/usr/bin/env python3
"""Create word-level timestamps and captions for the six-signals voiceover."""
...
AUDIO = ROOT / "audio" / "voiceover-final.mp3"
OUT = ROOT / "audio" / "voiceover-alignment.json"
SRT = ROOT / "captions-final.srt"
