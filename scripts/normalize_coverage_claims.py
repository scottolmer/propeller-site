...
REPLACEMENTS = {
    ...
    "highest-edge opportunities": "strongest model-confidence signals",
    "true implied probability": "normalized market-implied probability estimate",
    "No-Vig True Probability": "No-Vig Market Estimate",
    "No-Vig Probability": "No-Vig Market Estimate",
    "no-vig probability": "no-vig market estimate",
    "no-vig true probability": "no-vig market estimate",
    "with the highest edge": "with the strongest model-confidence signals",
    "focuses on edges where": "focuses on situations where",
    "The most actionable props": "Props that warrant closer review",
    "the most actionable props": "props that warrant closer review",
    "among the most repeatable edges in baseball": "a useful context to review, with no guarantee that a historical pattern will repeat",
    "surfaces these multi-factor edges automatically": "surfaces these multi-factor research signals",
    "confidence scores you can act on": "confidence context you can inspect",
    "that disagreement reveals uncertainty in the market that Propeller can exploit":
        "that disagreement reveals uncertainty for Propeller to flag for further review",
    "surfaces genuine edges rather than bookmaker margins":
        "surfaces differences between a model estimate and the normalized market estimate",
