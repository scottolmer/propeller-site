...
EXCLUDED_PARTS = {"mockups", "analytics-dashboard", "content", "docs", "reports", "node_modules", ".git"}
...
<nav class="pp-site-nav" aria-label="Primary navigation">
  <div class="pp-site-nav__inner">
    ...
    <div class="pp-site-nav__links" id="ppSiteNavLinks">
      ...
      <a class="pp-site-nav__cta" href="https://propellerpicks.com/pricing/" data-analytics-event="signup_click" data-cta-id="site-nav-pricing" data-cta-surface="site_nav" data-cta-destination="pricing">See pricing</a>
    </div>
  </div>
</nav>
<!-- PP_SITE_NAV_END -->"""
...
def migrate_html(original: str, path: Path, home: bool) -> str:
    ...
    if navigation_page or "pp-compare-lines" in original or "pp-ai-source-audit" in original or "pp-research-log" in original or "pp-pricing" in original or "pp-daily-archive" in original:
